...
from ...product.models import (
    ...
    ProductType, ProductVariant, VariantImage, ProductTranslation, ProductVariantTranslation, AttributeTranslation, AttributeValueTranslation)
...
class ProductForm(forms.ModelForm, AttributesMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['category'].initial = Product.objects.filter(
        #     category__name=
        # )
    ...
    def save(self, commit=True):
        ...
        # instance.category.add(self.id)
        for collection in self.cleaned_data['collections']:
            instance.collections.add(collection)
        return instance

class ProductTransForm(forms.ModelForm, AttributesMixin):
    class Meta:
        model = ProductTranslation
        exclude = ['product', 'description_json']
...
class VariantTranslationForm(forms.ModelForm, AttributesMixin):
    class Meta:
...
class AttributeTranslationForm(forms.ModelForm):
    class Meta:
...
class AttributeValueTranslationForm(forms.ModelForm):
    class Meta:
