...
urlpatterns = [
    ...
    url(r'^(?P<product_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/delete/$',
        views.translation_delete, name='translation-delete'),

    url(r'^(?P<product_pk>[0-9]+)/variants/(?P<variant_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/$',
        views.variant_translation_details, name='variant-translation-details'),
    url(r'^(?P<product_pk>[0-9]+)/variants/(?P<variant_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/update/$',
        views.variant_translation_edit, name='variant-translation-update'),
    url(r'^(?P<product_pk>[0-9]+)/variants/(?P<variant_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/delete/$',
        views.variant_translation_delete, name='variant-translation-delete'),
    ...
    url(r'attributes/(?P<attribute_pk>[0-9]+)/value/(?P<value_pk>[0-9]+)/details/$',  # noqa
        views.attribute_value_details, name='attribute-value-details'),
    ...
    url(r'attributes/(?P<attribute_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)$',
        views.attribute_translation_details, name='attribute-translation-details'),
    url(r'^add/attributes/translation/$',
        views.attribute_translation_create, name='attribute-translation-add'),
    url(r'attributes/(?P<attribute_pk>[0-9]+)/translation/add/$',
        views.attribute_translation_create, name='attribute-translation-add'),
    url(r'attributes/(?P<attribute_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/edit/$',
        views.attribute_translation_edit, name='attribute-translation-update'),
    url(r'attributes/(?P<attribute_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/delete/$',
        views.attribute_translation_delete, name='attribute-translation-delete'),

    url(r'^add/attributes/value/translation/$',
        views.attributevalue_translation_create, name='attributevalue-translation-add'),
    url(r'attributes/value/(?P<attvalue_pk>[0-9]+)/translation/add/$',
        views.attributevalue_translation_create, name='attributevalue-translation-add'),
    url(r'attributes/value/(?P<attvalue_pk>[0-9]+)/translation/(?P<translation_pk>[0-9]+)/edit/$',
