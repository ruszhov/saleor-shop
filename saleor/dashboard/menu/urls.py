...
urlpatterns = [
    ...
    url(r'^(?P<menu_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)$',
        views.menuitem_translation_details, name='menuitem-translation-details'),
    url(r'^add/menuitem/translation/$',
        views.menuitem_translation_create, name='menuitem-translation-add'),
    url(r'^(?P<menu_pk>[0-9]+)/translation/add/$',
        views.menuitem_translation_create, name='menuitem-translation-add'),
    url(r'^(?P<menu_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/edit/$',
        views.menuitem_translation_edit, name='menuitem-translation-update'),
    url(r'^(?P<menu_pk>[0-9]+)/translations/(?P<translation_pk>[0-9]+)/delete/$',
        views.menuitem_translation_delete, name='menuitem-translation-delete'),
