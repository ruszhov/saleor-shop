...
class AddressForm(forms.ModelForm):
    ...
    class Meta:
        model = Address
        exclude = ['company_name', 'street_address_1', 'street_address_2', 'city_area', 'postal_code', 'country_area']
        labels = {
            ...
            # "street_address_2": pgettext_lazy("Address", "Address"),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['street_address_1'].required = False
...
class CountryAwareAddressForm(AddressForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['country_area'].required = False
